...
ActiveRecord::Schema.define(version: 20190705005537) do
  ...
  create_table "spree_product_imports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["job_id"], name: "index_spree_product_imports_on_job_id"
    t.index ["status"], name: "index_spree_product_imports_on_status"
  end
